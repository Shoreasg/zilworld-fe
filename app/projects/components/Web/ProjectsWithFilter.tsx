...
export default function ProjectsWithFilter({
  ...
  projectsData,
  projectsRef,
}: Readonly<ProjectWithFilterProps>) {
  ...
  return (
    <div className="flex flex-col">
      <div
        className="sticky bg-[#F5F5F5] top-0 flex w-full py-6 items-end gap-2 px-14 z-20 "
        ref={projectsRef}
      >
        <SearchBar
      ...
      <hr className="border-t-[1px] border-[#D5DEE0] mx-14" />
