...
export default function MobileProjectsWithFilter({
  ...
  return (
    <div className="flex flex-col">
      <div className={`${searchBarReachTop === true ? " sticky top-0 z-30 w-full flex flex-col h-20 p-4 justify-between items-center flex-shrink-0 bg-[#F5F5F5]":""}`}>
      <div ref={projectsRef} className={`${searchBarReachTop === true ? "flex justify-end items-start gap-4 self-stretch":""}`}>
