...
export default function NavBarV2({ setMenuClick }: NavBarProps) {
  ...
  const [isShownPopUp, setIsShownPopUp] = useState<string>("");
  ...
  return (
    <>
      {menuClickContext ? (
        <div
          className={`flex flex-col justify-between w-[80px] h-screen bg-[#097A8E] flex-shrink-0 self-stretch overflow-y-auto transition-all ease-in-out duration-200`}
        >
            ...
            <div className=" w-full">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  onMouseEnter={() => setIsShownPopUp(item.name)}
                  onMouseLeave={() => setIsShownPopUp("")}
          ...
          <div className="flex flex-col justify-center items-start p-0 w-full">
            ...
            <div className="w-full">
              ...
              <div className="w-full flex flex-row justify-center items-center pt-2 pb-2 pl-0 pr-0 m-0 bg-[#275B6B] shadow-[0px_0px_10px_rgba(6,36,46,0.15)]">
                <span
                  className={`text-[#f5f5f5] ${plusJakartaSans.className} p-0 m-0 font-normal text-sm tracking-[0.03125rem]`}
                >
                  #zilfam
                </span>
              </div>
        ...
        <div
          className={`flex flex-col justify-between w-[16rem] h-screen bg-[#097A8E] p-0 m-0 overflow-y-auto flex-shrink-0 self-stretch transition-all ease-in-out duration-150`}
        >
          <div className="flex flex-col justify-center items-start p-0 w-full">
            <div className="flex flex-col justify-center items-center h-[8.25rem] p-0 w-full">
              <Image
            ...
            <div className=" w-full">
              {navigation.map((item) => (
                ...
                >
                  ...
                  />
                  <span
                    className={`p-0  ${plusJakartaSans.className} font-medium text-base`}
                  >
                    {item.name}
                  </span>
                </Link>
              ...
              <div className="flex flex-col items-start pb-[0.5rem] text-[#f5f5f5] bg-[#097A8E] font-normal text-[0.875rem] w-full">
                {thirdNavigation.map((item) => (
                  ...
                  >
                    ...
                    <span
                      className={`p-0 ${plusJakartaSans.className} font-normal text-sm`}
                    >
                      {item.name}
                    </span>
                  </Link>
