...
import ProjectUpdatesMobile from "./ProjectsUpdatesMobile";
  ...
  export default function ProjectDetailsMobile({
    ...
    return (
      <div className=" inline-flex flex-col items-start w-full">
                ...
                {projectData.isBuilding ? (
                  ...
                  <>
                    ...
                    {projectData.isActive ? (
                      ...
                      <div className="flex relative h-4 px-2 justify-center items-center gap-1 rounded-[32px] bg-[#b5202062] leading-tight font-plusjakartasans text-[10px] font-normal ">
                        Inactive
                        <InformationCircleIcon
                          className="h-[10px] w-[10px]"
                          onMouseEnter={() => setOnHoverInactive(true)}
                          onMouseLeave={() => setOnHoverInactive(false)}
                          onClick={() => setOnHoverInactive(true)}
                        />
                        {onHoverInactive && (
                          <div className="tooltip absolute top-[26px] left-auto flex flex-col justify-start items-stretch py-4 px-6 gap-2 rounded-lg bg-gray-200 shadow-md w-56 font-plusjakartasans text-xs font-normal leading-[18px] -20">
                            <p>
                              Unfortunately, this project has been labeled as
                              inactive due to a lack of updates or being abandoned.
                            </p>
                          </div>
                        )}
                      </div>
        ...
        <div className="flex flex-col justify-start self-stretch py-8 w-full h-16">
          <hr className="border-t-[1px] self-stretch flex-grow-0 border-[#D5DEE0] w-full" />
          <ProjectUpdatesMobile projectData={projectData}/>
        </div>
      </div>
    );
  }
